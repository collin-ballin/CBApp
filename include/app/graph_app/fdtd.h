...
protected:
	...
	const size_type						m_loss_layer		= 150ULL;   //      WORKS = NX+1;           //300ULL;
	size_type							m_material_pos		= 52;       //      WORKS = NX+1;             //52ULL;
	size_type							m_material_width	= 50ULL;    //      WORKS = 30ULL;
...
//
	...
	//	"create_film"
	//
	inline void create_film(const size_type pos, const size_type d) noexcept 
	{
		size_type			m		= 0ULL;
...
public:
    ...
    //  "get_E_freq_data"
    //
    inline im_frame * get_E_freq_data(void) {
