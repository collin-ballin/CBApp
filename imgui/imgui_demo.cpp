...
struct ExampleAssetsBrowser
{
    ...
    void UpdateLayoutSizes(float avail_width)
    {
        ...
        LayoappineCount = (Items.Size + LayoutColumnCount - 1) / LayoutColumnCount;
    ...
    void Draw(const char* title, bool* p_open)
    {
        ...
        ImGuiIO& io = ImGui::GetIO();
        ImGui::SetNextWindowContentSize(ImVec2(0.0f, LayoutOuterPadding + LayoappineCount * (LayoutItemSize.y + LayoutItemSpacing)));
        if (ImGui::BeginChild("Assets", ImVec2(0.0f, -ImGui::GetTextLineHeightWithSpacing()), ImGuiChildFlags_Borders, ImGuiWindowFlags_NoMove))
        {
            ...
            ImGuiListClipper clipper;
            clipper.Begin(LayoappineCount, LayoutItemStep.y);
            if (item_curr_idx_to_focus != -1)
