...
void App::run(void)
{
...
#endif  //  __EMSCRIPTEN__  //
    {
        ...
        //  6.  UPDATE & RENDER ADDITIONAL PLATFORM WINDOWS...
...
void App::run_IMPL(void)
{
    ...
    this->Display_Sidebar_Menu(nullptr);    // (&this->m_show_sidebar_menu);

    //  2.  DISPLAY THE MAIN APPLICATION WINDOW...
    // if (this->m_show_main_window)    this->Display_Main_Window(&this->m_show_main_window);
    this->Display_Main_Window(nullptr);
    
    
    //  3.  DISPLAY THE STYLE-EDITOR WINDOW...
...
void App::Display_Main_Window(bool * p_open)
{
    ...
    ImGuiIO &                       io              = ImGui::GetIO(); (void)io;
    this->m_win_flags                              |=  ImGuiWindowFlags_None | ImGuiWindowFlags_MenuBar | ImGuiWindowFlags_NoCollapse; // ImGuiWindowFlags_NoSavedSettings
...
//#ifdef CBAPP_USE_VIEWPORT
//    ImGui::SetNextWindowDockID(this->m_dock_ID, ImGuiCond_FirstUseEver);
//#endif  //  CBAPP_USE_VIEWPORT  //
