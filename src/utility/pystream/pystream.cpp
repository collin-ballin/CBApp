...
//
//
//  1B.     PUBLIC UTILITY FUNCTIONS...
// *************************************************************************** //
// *************************************************************************** //

//  "set_filepath"
//
void PyStream::set_filepath(const char * src) {
    this->m_script_path = std::string(src);
}


//  "set_filepath"
//
void PyStream::set_filepath(const std::string & src) {
    this->m_script_path = std::string(src);
}
...
//  "get_filepath"
//
std::string PyStream::get_filepath(void) {
    return this->m_script_path;
}
